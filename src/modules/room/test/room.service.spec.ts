...
describe('RoomService', () => {
  ...
  describe('inviteUserToRoom', () => {
    it('should invite a user to a room', async () => {
      ...
      expect(await service.inviteUserToRoom({ userEmail: 'test@test.com', roomId: '1' } as InviteUserRoomDto)).toStrictEqual(result);
    });
    ...
    it('should throw NotFoundException if user not found', async () => {
      ...
      await expect(
        service.inviteUserToRoom({ userEmail: 'test@test.com', roomId: '1' } as InviteUserRoomDto)
